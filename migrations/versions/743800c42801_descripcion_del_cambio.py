...
Revision ID: 743800c42801
Revises: 
Create Date: 2025-11-24 01:29:58.883087
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('tienda', sa.String(length=255), nullable=False),
    ...
    sa.Column('talla', sa.String(length=255), nullable=False),
